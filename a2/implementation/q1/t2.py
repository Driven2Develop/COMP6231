...
class MultiProcessingSolution:
    ...
    def __init__(self, num_of_processes=None, dataset_path=None, dataset_size=None):
        self.num_of_processes = min(multiprocessing.cpu_count(), num_of_processes)
        self.dataset_path = dataset_path
        self.dataset_size = dataset_size
        self.start_time = time.time()
        self.dataset_columns = ["FlightDate", "Airline", "Origin"]
    ...
    """
    def run(self):
        print("Iymen Abdella | 40218280 | COMP 6231 FALL 2023 | Assignment 2: Parallel Programming | Q1 T2")
